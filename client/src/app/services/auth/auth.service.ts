...
export class AuthService implements OnDestroy {
	...
	private orcidInfo = {
		client_id: "27ebbf38-5382-4cc0-b61e-287fdac29009",
		response_type: "code",
		scope: "/authenticate",
	...
	constructor(private http: HttpClient) {
		this.serverUrl = "https://login.microsoftonline.com/371cb917-b098-4303-b878-c182ec8403ac/oauth2/authorize";//environment.host + this.serverUrl;
